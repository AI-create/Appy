...
# Setup Appium options for OnePlus 9R
options = UiAutomator2Options()
options.platform_name = 'Android'
options.udid = 'emulator-5554'  # Use the correct UDID from adb devices
...
options.device_name = 'OnePlus 9R'  # Updated device name
options.automation_name = 'UiAutomator2'
options.platformVersion = '34'  # Adjusted API version
